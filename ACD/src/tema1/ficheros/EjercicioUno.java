...
/**
 * Ejercicios utilizando la clase File
 * 
 * @author amna
 * @version 1.0
 */
public class EjercicioUno {
	...
	public static void main(String[] args) {
		...
		// ejercicioUno.listarArbolDirectorios(new
		// File("C:\\Users\\Usuario\\Desktop\\d"));
...
//		 ".xml");
	 ...
	 */
	public void listarArbolDirectorios(File dir) {
		File listFiles[] = dir.listFiles();
		for (int i = 0; i < listFiles.length; i++) {
			if (listFiles[i].isDirectory()) {
				listarArbolDirectorios(listFiles[i]);
			}
